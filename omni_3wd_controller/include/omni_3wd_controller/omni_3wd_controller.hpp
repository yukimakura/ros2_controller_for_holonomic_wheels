...
#ifndef omni_3wd_CONTROLLER_HPP_
#define omni_3wd_CONTROLLER_HPP_
...
#include "omni_3wd_controller_parameters.hpp"

namespace omni_3wd_controller
{
    class Omni3WDController : public controller_interface::ControllerInterface
    {
        using Twist = geometry_msgs::msg::TwistStamped;

    public:
        Omni_3WD_CONTROLLER_PUBLIC
        Omni3WDController();
    ...
    protected:
        ...
        std::shared_ptr<WheelHandle> registered_front_wheel_handles_;
...
#endif // omni_3wd_CONTROLLER_HPP_