...
class TestableOmni3WDController : public omni_3wd_controller::Omni3WDController
{
public:
    //   using omni_3wd_controller::Omni3WDController;
...
class TestOmni3WDController : public ::testing::Test
{
protected:
    ...
    void SetUp() override
    {
        controller_ = std::make_unique<TestableOmni3WDController>();
    ...
    const std::string controller_name = "test_omni_3wd_controller";
    std::unique_ptr<TestableOmni3WDController> controller_;
...
TEST_F(TestOmni3WDController, configure_fails_with_only_left_or_only_right_side_defined)
{
...
TEST_F(TestOmni3WDController, configure_succeeds_when_wheels_are_specified)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, configure_succeeds_tf_test_prefix_false_no_namespace)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, configure_succeeds_tf_test_prefix_true_no_namespace)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, configure_succeeds_tf_blank_prefix_true_no_namespace)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, configure_succeeds_tf_test_prefix_false_set_namespace)
{
...
TEST_F(TestOmni3WDController, configure_succeeds_tf_test_prefix_true_set_namespace)
{
    std::string test_namespace = "/test_namespace";
...
TEST_F(TestOmni3WDController, configure_succeeds_tf_blank_prefix_true_set_namespace)
{
    std::string test_namespace = "/test_namespace";
...
TEST_F(TestOmni3WDController, activate_fails_without_resources_assigned)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, activate_succeeds_with_pos_resources_assigned)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, activate_succeeds_with_vel_resources_assigned)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, activate_fails_with_wrong_resources_assigned_1)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, activate_fails_with_wrong_resources_assigned_2)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, cleanup)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestOmni3WDController, correct_initialization_using_parameters)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
