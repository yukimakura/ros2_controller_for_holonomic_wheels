...
#include "quadomni_drive_controller/quadomni_drive_controller.hpp"
...
class TestableQuadOmniDriveController : public quadomni_drive_controller::QuadOmniDriveController
{
public:
    //   using quadomni_drive_controller::QuadOmniDriveController;
...
class TestQuadOmniDriveController : public ::testing::Test
{
protected:
    ...
    void SetUp() override
    {
        controller_ = std::make_unique<TestableQuadOmniDriveController>();
    ...
    const std::string controller_name = "test_quadomni_drive_controller";
    std::unique_ptr<TestableQuadOmniDriveController> controller_;
...
TEST_F(TestQuadOmniDriveController, configure_fails_with_only_left_or_only_right_side_defined)
{
...
TEST_F(TestQuadOmniDriveController, configure_succeeds_when_wheels_are_specified)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, configure_succeeds_tf_test_prefix_false_no_namespace)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, configure_succeeds_tf_test_prefix_true_no_namespace)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, configure_succeeds_tf_blank_prefix_true_no_namespace)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, configure_succeeds_tf_test_prefix_false_set_namespace)
{
...
TEST_F(TestQuadOmniDriveController, configure_succeeds_tf_test_prefix_true_set_namespace)
{
    std::string test_namespace = "/test_namespace";
...
TEST_F(TestQuadOmniDriveController, configure_succeeds_tf_blank_prefix_true_set_namespace)
{
    std::string test_namespace = "/test_namespace";
...
TEST_F(TestQuadOmniDriveController, activate_fails_without_resources_assigned)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, activate_succeeds_with_pos_resources_assigned)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, activate_succeeds_with_vel_resources_assigned)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, activate_fails_with_wrong_resources_assigned_1)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, activate_fails_with_wrong_resources_assigned_2)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, cleanup)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestQuadOmniDriveController, correct_initialization_using_parameters)
{
    const auto ret = controller_->init(controller_name);
    ASSERT_EQ(ret, controller_interface::return_type::OK);
