...
namespace quadomni_drive_controller
{
    ...
    const char *QuadOmniDriveController::feedback_type() const
    {
        return params_.position_feedback ? HW_IF_POSITION : HW_IF_VELOCITY;
    }

    QuadOmniDriveController::QuadOmniDriveController() : controller_interface::ControllerInterface() {}

    controller_interface::CallbackReturn QuadOmniDriveController::on_init()
    {
        try
        {
    ...
    controller_interface::InterfaceConfiguration QuadOmniDriveController::command_interface_configuration() const
    {
    ...
    controller_interface::InterfaceConfiguration QuadOmniDriveController::state_interface_configuration() const
    {
        std::vector<std::string> conf_names;
    ...
    /// @param period
    /// @return
    controller_interface::return_type QuadOmniDriveController::update(
    ...
    controller_interface::CallbackReturn QuadOmniDriveController::on_configure(
    ...
    controller_interface::CallbackReturn QuadOmniDriveController::on_activate(
        const rclcpp_lifecycle::State &)
    {
    ...
    controller_interface::CallbackReturn QuadOmniDriveController::on_deactivate(
        const rclcpp_lifecycle::State &)
    {
    ...
    controller_interface::CallbackReturn QuadOmniDriveController::on_cleanup(
        const rclcpp_lifecycle::State &)
    {
        if (!reset())
        {
    ...
    controller_interface::CallbackReturn QuadOmniDriveController::on_error(const rclcpp_lifecycle::State &)
    {
        if (!reset())
        {
            return controller_interface::CallbackReturn::ERROR;
    ...
    bool QuadOmniDriveController::reset()
    {
    ...
    controller_interface::CallbackReturn QuadOmniDriveController::on_shutdown(
        const rclcpp_lifecycle::State &)
    {
        return controller_interface::CallbackReturn::SUCCESS;
    }

    void QuadOmniDriveController::halt()
    {
    ...
    controller_interface::CallbackReturn QuadOmniDriveController::configure_side(
...
CLASS_LOADER_REGISTER_CLASS(
    quadomni_drive_controller::QuadOmniDriveController, controller_interface::ControllerInterface)
